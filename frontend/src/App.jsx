...
const SocketDrive = lazy(() => import("./games/socket-drive/src/index.jsx"));
const ProfileRouter = lazy(() => import("./features/profile/ProfileRouter"));
const MyGodotGamePage = lazy(() => import("./pages/games/MyGodotGamePage.jsx"));
...
const ProjectInfoPage = lazy(() => import("./pages/public/static/ProjectInfoPage.jsx"));
        ...
        <Suspense fallback={<PageLoader />}>
          <Routes>
            ...
            <Route element={<ProtectedRoute />}>
              ...
              <Route path="/games/socket-drive/play" element={<SocketDrive />} />
              <Route path="/games/stack-mate/play" element={<MyGodotGamePage />} />
            </Route>
