        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 auto-rows-auto">
          ...
          <div className="bg-slate-800/60 rounded-3xl p-6 md:col-span-2 md:row-span-2 backdrop-blur-sm border border-slate-700/30 hover:border-orange-500/50 transition-all group">
            <div className="flex justify-between items-start mb-4">
              <h3 className="text-2xl font-bold text-white group-hover:text-orange-400 transition-colors">High Quality 3D Models</h3>
              <Move3D className="w-8 h-8 text-orange-400" />
            </div>
            <p className="text-slate-300 mb-6">Hand-crafted 3D models with exceptional detail and performance optimization.</p>
            <div className="relative h-110 bg-gradient-to-br from-slate-700/40 to-slate-800/40 rounded-2xl overflow-hidden flex items-center justify-center">
              ...
              <span className="absolute bottom-4 left-4 bg-orange-500/90 text-white px-3 py-1 rounded-full text-sm font-medium">Premium Quality</span>
            </div>
          </div>
          ...
          <div className="bg-slate-800/60 rounded-3xl p-6 md:col-span-1 backdrop-blur-sm border border-slate-700/30 hover:border-blue-500/50 transition-all group">
            <div className="flex justify-between items-start mb-3">
              <h3 className="text-xl font-bold text-white group-hover:text-blue-400 transition-colors">Secure Authentication</h3>
          ...
          <div className="bg-slate-800/60 rounded-3xl p-6 md:col-span-2 backdrop-blur-sm border border-slate-700/30 hover:border-green-500/50 transition-all group">
            <div className="flex justify-between items-start mb-3">
              <h3 className="text-xl font-bold text-white group-hover:text-green-400 transition-colors">Immersive 3D Games</h3>
              <Gamepad2 className="w-6 h-6 text-green-400" />
            </div>
            <p className="text-slate-300 text-sm mb-4">Interactive gaming experiences with stunning 3D environments.</p>
            <div className="h-40 bg-gradient-to-br from-slate-700/40 to-slate-800/40 rounded-xl overflow-hidden flex items-center justify-center">
              ...
              <span className="absolute bottom-3 left-3 bg-green-500/90 text-white px-3 py-1 rounded-full text-sm font-medium">Play Now</span>
            </div>
          </div>
          ...
          <div className="bg-slate-800/60 rounded-3xl p-6 backdrop-blur-sm border border-slate-700/30 hover:border-purple-500/50 transition-all group">
            <div className="flex justify-between items-start mb-3">
              <h3 className="text-xl font-bold text-white group-hover:text-purple-400 transition-colors">Modern Design</h3>
              <LayoutGrid className="w-6 h-6 text-purple-400" />
            </div>
            <p className="text-slate-300 text-sm">Sleek interfaces with cutting-edge UI/UX principles.</p>
          </div>
          ...
          <div className="bg-slate-800/60 rounded-3xl p-6 md:row-span-2 backdrop-blur-sm border border-slate-700/30 hover:border-yellow-500/50 transition-all group">
            <div className="flex justify-between items-start mb-3">
              <h3 className="text-xl font-bold text-white group-hover:text-yellow-400 transition-colors">Global Leaderboard</h3>
              <Trophy className="w-6 h-6 text-yellow-400" />
            </div>
            <p className="text-slate-300 text-sm mb-4">Compete with users worldwide and track your progress.</p>
          ...
          <div className="bg-slate-800/60 rounded-3xl p-6 md:col-span-1 backdrop-blur-sm border border-slate-700/30 hover:border-teal-500/50 transition-all group">
            <div className="flex justify-between items-start mb-3">
              <h3 className="text-xl font-bold text-white group-hover:text-teal-400 transition-colors">3D Interactions</h3>
              <Box className="w-6 h-6 text-teal-400" />
            </div>
            <p className="text-slate-300 text-sm mb-4">Intuitive 3D object manipulation and interactions.</p>
            <div className="h-32 bg-gradient-to-br from-slate-700/40 to-slate-800/40 rounded-xl overflow-hidden flex items-center justify-center">
              <img 
          ...
          <div className="bg-slate-800/60 rounded-3xl p-6 md:col-span-2 backdrop-blur-sm border border-slate-700/30 hover:border-pink-500/50 transition-all group">
            <div className="flex justify-between items-start mb-3">
              <h3 className="text-xl font-bold text-white group-hover:text-pink-400 transition-colors">Advanced Analytics</h3>
              <svg className="w-6 h-6 text-pink-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
              </svg>
            </div>
            <p className="text-slate-300 text-sm mb-4">Comprehensive data visualization and performance insights.</p>
