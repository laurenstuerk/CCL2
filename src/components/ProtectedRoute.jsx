...
const ProtectedRoute = () => {
  ...
  // 3. When the check is complete and NO user is present, redirect to the login page.
  // We save the original location to redirect the user back there after logging in.
