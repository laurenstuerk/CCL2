    ...
    <group position={position}>
      <Float floatIntensity={0.25} rotationIntensity={0.25}>
        ...
        >
          ...
          rotation-y={1.4}
        >
          Finish the course as fast as you can!
          <meshBasicMaterial toneMapped={false} />
        </Text>
...
function BlockEnd({ position = [0, 0, 0] }) {
  ...
  return (
    <group position={position}>
      ...
      <RigidBody type="fixed" cilliders="hull" position={[0, 0.25, 0]} restitution={0.2} friction={0}>
...
export function Level({ count = 10, types = [BlockSpinner, BlockLimbo, BlockAxe], seed = 0 }) {
